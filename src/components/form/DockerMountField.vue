        ...
        <v-card outlined>
          <v-container fluid>
            <v-row v-for="(record, index) in value" :key="index" dense>
              <v-col cols="5">
                <v-text-field v-model="record.source" label="Source" :rules="validate"></v-text-field>
              </v-col>
              <v-col cols="5">
                <v-text-field v-model="record.target" label="Target" :rules="validate"></v-text-field>
              </v-col>
              <v-col cols="2">
